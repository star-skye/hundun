...
public class Elf implements Closeable
{
  ...
  public static void readFully( ReadableByteChannel ch, ByteBuffer buf, String errMsg ) throws IOException
  {
    buf.rewind();
  ...
  public Elf( FileChannel channel ) throws IOException
  {
    ...
    for ( int i = 0; i < sectionHeaderEntryCount; i++ )
    {
      ...
      SectionHeader sHdr = new SectionHeader( header.elfClass, buf,channel);
      if ( i == 0 )
      {
